...
// Home Screen String
const HME_HINT_SEARCH_TEXT = 'Enter your college';
const HME_NEARBY_TEXT = 'Nearby';
const HME_INSPIRATION_TEXT = 'RESIDENCE';
...
const DTL_SAMPLE_DESCRIPT_TEXT =
    'We serve the best facilities for our costumers.';
const DTL_BOOKING_TEXT = 'Book Now';
const DTL_LOCATION_TEXT = 'location';
